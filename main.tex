...
\item[Code and documentation:] \url{https://github.com/vrnccr/neural_odes_bsc_seminar}
...
Several AI tools supported the preparation of this report. ChatGPT Codex
assisted with implementing the numerical experiments, generating figures, and 
revising the language. Prism AIwas used for LaTeX editing and compilation support, 
while ChatGPThelped with wording, clarity, grammar, and parts of the code. I reviewed the
generated text and code, checked the experimental results against the known
equations, and remain responsible for the sources, interpretations, and
